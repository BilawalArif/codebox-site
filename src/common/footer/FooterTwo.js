                ...
                <div className="rn-footer-widget">
                  ...
                  <div className="inner">
                    ...
                    <ul className="social-icon social-default justify-content-start">
                      ...
                      <li>
                        <a
                          href="https://www.linkedin.com/company/code-boxx/"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <FiLinkedin />
