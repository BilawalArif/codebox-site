...
const BannerData = [
    {
        image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80",
                                        ...
                                        <div className="col-lg-12">
                                            <div className="inner text-center">
                                                ...
                                                <div className="button-group mt--30">
                                                    <a className="btn-default btn-large round" target="_blank" href="/">Get started now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
